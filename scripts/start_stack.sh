...
mkdir -p "$HUB_DIR/data/abb_tts/data/temp"
mkdir -p "$HUB_DIR/data/abb_tts/data/output"
...
echo "  - data/abb_tts/data/temp       (temp files)"
echo "  - data/abb_tts/data/output     (audiobooks)"
